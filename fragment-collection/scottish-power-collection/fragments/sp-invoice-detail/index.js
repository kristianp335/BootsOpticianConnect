...
(function() {
  ...
  const fragmentElement = document.currentScript?.closest('.sp-invoice-detail-fragment') || 
                         document.querySelector('.sp-invoice-detail-fragment');
...
This is a generated invoice summary from the Boots Partner Portal.
  ...
  function showDownloadFeedback(button) {
    ...
    button.innerHTML = `
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" class="sp-download-icon">
