...
(function() {
    ...
    function initializeModuleFilters() {
        ...
        const moduleCards = fragmentElement.querySelectorAll('.sp-module-card');
    ...
    function createProgressChart() {
        const canvas = fragmentElement.querySelector('#sp-progress-chart');
        if (!canvas) return;
    ...
    function showChartError() {
        const chartContainer = fragmentElement.querySelector('.sp-chart-container');
        if (chartContainer) {
            chartContainer.innerHTML = '<div class="sp-chart-error">Unable to load chart. Please refresh the page.</div>';
        }
    }
    ...
    function animateGoalProgress() {
        const progressBars = fragmentElement.querySelectorAll('.sp-goal-fill');
    ...
    function bindInteractionEvents() {
        ...
        const registerBtns = fragmentElement.querySelectorAll('.sp-upcoming-actions .sp-btn-primary');
        registerBtns.forEach(function(btn) {
            btn.addEventListener('click', function(e) {
                ...
                this.classList.remove('sp-btn-primary');
                this.classList.add('sp-btn-outline');
                this.disabled = true;
            });
        });
        
        // Achievement animations
        const achievementItems = fragmentElement.querySelectorAll('.sp-achievement-item');
        achievementItems.forEach(function(item) {
            item.addEventListener('mouseenter', function() {
                const icon = this.querySelector('.sp-achievement-icon');
                if (icon) {
