...
(function() {
    ...
    function createRevenueChart() {
        const canvas = fragmentElement.querySelector('#sp-revenue-chart');
        if (!canvas) return;
    ...
    function createAppointmentsChart() {
        const canvas = fragmentElement.querySelector('#sp-appointments-chart');
        if (!canvas) return;
    ...
    function showChartError() {
        const chartContainers = fragmentElement.querySelectorAll('.sp-chart-container');
        chartContainers.forEach(function(container) {
            container.innerHTML = '<div class="sp-chart-error">Unable to load chart. Please refresh the page.</div>';
        });
    }
    ...
    function bindInteractionEvents() {
        ...
        const metricCards = fragmentElement.querySelectorAll('.sp-metric-card');
        ...
        const announcementItems = fragmentElement.querySelectorAll('.sp-announcement-item');
        ...
        const actionItems = fragmentElement.querySelectorAll('.sp-action-item');
        actionItems.forEach(function(item) {
            item.addEventListener('click', function() {
                ...
                setTimeout(function() {
                    item.innerHTML += '<div class="sp-action-completed">Completed!</div>';
                }, 300);
            });
        });
    }
