...
(function() {
    ...
    function initializeChartWidget() {
        ...
        const chartWidget = container.querySelector('.boots-chart-widget-fragment');
    ...
    function initializePeriodControls() {
        const container = (typeof fragmentElement !== 'undefined') ? fragmentElement : document;
        const controls = container.querySelectorAll('.boots-chart-controls .boots-btn');
    ...
    function showLoading() {
        const container = (typeof fragmentElement !== 'undefined') ? fragmentElement : document;
        const chartContainer = container.querySelector('.boots-chart-container');
        if (chartContainer) {
            chartContainer.innerHTML = '<div class="boots-chart-loading">Loading chart data...</div>';
        }
    }
    ...
    function hideLoading() {
        const container = (typeof fragmentElement !== 'undefined') ? fragmentElement : document;
        const loading = container.querySelector('.boots-chart-loading');
        if (loading) {
            loading.remove();
        }
    }
    ...
    function showError(message) {
        ...
        const chartContainer = container.querySelector('.boots-chart-container');
        if (chartContainer) {
            chartContainer.innerHTML = '<div class="boots-chart-error">' + message + '</div>';
        }
    }
