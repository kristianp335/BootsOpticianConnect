...
(function() {
    ...
    function getMenuIcon(itemName) {
        const iconMap = {
            'Dashboard': '<svg width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M2 10C2 10 5 4 10 4S18 10 18 10S15 16 10 16S2 10 2 10Z" stroke="currentColor" stroke-width="2"/><circle cx="10" cy="10" r="3" stroke="currentColor" stroke-width="2"/></svg>',
