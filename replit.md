...
- **DASHBOARD MENU ICON**: Replaced hamburger menu lines with dashboard-type SVG icon (2x2 grid of squares) - better represents the portal functionality and provides clearer visual indication of menu purpose (August 20, 2025)
